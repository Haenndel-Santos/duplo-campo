# -*- coding: utf-8 -*-
"""
r7e_autopsia_janela.py — R-7e AUTOPSIA: as taxas +1.8..+11.6 H da
...
MEDIDAS (pre-declaradas), mesmos 4 modos (kh_janela 10/3/1/0.3),
...
with open(os.path.join(HERE, 'out', 'r7e_autopsia_janela.txt'), 'w',
