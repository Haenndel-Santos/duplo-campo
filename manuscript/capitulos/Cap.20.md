**CAPÍTULO 20 --- Solução Estática Completa + Limites PPN na TDCP-F1**

**20.1 Objetivo e estratégia**
...
No Sistema Solar, tomamos \phi\simeq \phi_0 + \delta\phi(r) e trataremos \delta\phi como subdominante (a consistência disso será explicitada em 20.7).

**20.3 Potenciais em presença de um escalar acoplado: decomposição física**
...
**20.4 Relação entre \Phi,\Psi e o helicity-0 no limite de desacoplamento**
...
**20.5 Inclusão correta de F(\phi) no raio de Vainshtein e nos limites**

Do Cap.19 consolidado:
...
**20.6 Bound de Cassini: desigualdade paramétrica explícita**
...
**20.7 Quinta força adicional via \phi: condição de inocuidade local**
...
Resumo: o Cap.20 fecha o bloco solar exigindo que \phi não introduza uma nova quinta força não-screened. Na TDCP-F1, isso é obtido se \phi não acopla diretamente à matéria e suas variações locais forem pequenas.

**20.8 Parâmetro \beta_{\rm PPN}: estrutura e hierarquia esperada**
