...
| Lote 4 — C16–C21 (184 eqs) | **feito** — `lotes/lote_04_C16-C21.md` (94 CONFERE, 20 SOB HIPÓTESE, 62 ERRO, 5 INCOMPLETA, 3 NÃO-DERIVÁVEL) |
...
| Lotes seguintes — Anexos AB–AL (na ordem B→L; AB tem 71 eqs, é o maior arquivo) | pendente |
