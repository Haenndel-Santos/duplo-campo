Abaixo está o Capítulo 20 completo, consolidado, incorporando:
...
**CAPÍTULO 20 --- Screening e Regime Não-Linear na TDCP-F1**

**20.1 Objetivo Físico**
...
**20.2 Estrutura Gravitacional Relevante**
...
**20.4 Lagrangiana Efetiva do Helicity-0**
...
**20.9 Supressão da Quinta Força**
...
**20.10 Critério Paramétrico PPN**
...
A verificação formal será feita no Cap.21.
...
**CAPÍTULO 21 --- Solução Estática Completa e Parâmetros PPN**
